...
import com.testlslavag76.androidwithkotlin.databinding.HistoryFragmentBinding
import com.testlslavag76.androidwithkotlin.model.AppState
import com.testlslavag76.androidwithkotlin.viewmodel.HistoryViewModel
    ...
    private fun renderData(appState: AppState) {
        when (appState) {
            ...
            is AppState.Error -> {
                binding.historyFragmentRecyclerview.show()
                binding.includedLoadingLayout.loadingLayout.hide()
                binding.historyFragmentRecyclerview.showSnacBar(
